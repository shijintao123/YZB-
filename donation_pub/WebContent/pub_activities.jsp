						...
						<div class="resp-tabs-container">
							<div class="tab-1 resp-tab-content" aria-labelledby="tab_item-0">
								<div class="tab_img" >
									...
									<table border="1" >
										<tr>
											<c:if test="${not empty selAllActivity}">
												<c:forEach var="activity" items="${selAllActivity}"
													varStatus="status">
													<c:if test="${(status.index+1) mod 3 !=1}">
														...
														<div width="239" height="390">
															<a href="single.html"
																...
																<img class="img-responsive" src="${activity.picture }"
															...
															<div class="fashion">
																...
																<a href="morepub_activities?id=${activity.id }" class="btn  btn-1c btn1 btn-1d">更多信息</a>
															</div>
														</div>
													</td>
													</c:if>
													<c:if test="${(status.index+1) mod 3==1}">
														...
														<div width="239" height="390">
															<a href="single.html"
																...
																class="img-responsive" src="${activity.picture }"
																style="top: 0px;" alt="" width="450" height="300"/>
																<div class="b-wrapper">
																	<h2 class="b-animate b-from-left    b-delay03 ">
																		<img src="images/plus.png" alt="" style="top: 0px;">
